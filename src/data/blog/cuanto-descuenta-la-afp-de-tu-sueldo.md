...
En esta guía te explicamos todo de forma simple. Si quieres ver cómo este descuento conversa con salud, cesantía e impuesto único, parte por el [hub de sueldo y remuneraciones](/guias/sueldo-remuneraciones/) y luego cruza con la guía de [cómo calcular tu sueldo líquido](/posts/como-calcular-sueldo-liquido/).
...
- Cada mes se deposita el 10% de tu sueldo bruto
...
Este porcentaje cubre los costos operacionales de la AFP: administración, inversiones, atención al cliente y el **Seguro de Invalidez y Sobrevivencia (SIS)**, que te protege en caso de quedar con invalidez permanente o en caso de fallecimiento.
...
Una diferencia de 0.28% entre la AFP más cara y la más barata puede parecer pequeña, pero en un sueldo de $1.000.000 son $2.800 mensuales, o **$33.600 al año**.
