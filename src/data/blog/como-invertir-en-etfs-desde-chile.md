...
Si quieres invertir en ETFs desde Chile, esta guía te ordena el proceso de selección de intermediario, control de costos, custodia y revisión tributaria básica antes de ejecutar tu primera orden. Para la vista completa del cluster, revisa [ahorro e inversión en Chile](/posts/ahorro-e-inversion-en-chile-instrumentos-costos-impuestos-2026/).

## Qué necesitas antes de invertir

- Objetivo y horizonte de inversión definidos.
- Tolerancia a volatilidad explícita.
- Cuenta con intermediario habilitado.
...
- Riesgo de ejecución: diferencias de precio (spread) y horarios de mercado pueden afectar resultado real.
...
- Usa ETF para diversificar por región/activo.
- Rebalancea en ventanas definidas para evitar sobreoperar.

### Agresivo

- Mayor exposición a renta variable global.
- Asume volatilidad alta y exige disciplina en costos, moneda y tributación.
...
**1) ¿Necesito sí o sí un corredor para invertir ETFs?**
Para operar en mercado bursátil, necesitas intermediación. CMF detalla el rol de corredores y agentes.

**2) ¿Qué costo suele subestimarse más?**
...
**5) ¿Cuál es la principal diferencia con fondos mutuos?**
ETF se transa en bolsa; fondo mutuo opera por valor cuota y reglas de rescate del fondo.

**6) ¿Cómo reduzco errores al empezar?**
Usa un checklist fijo de costos, custodia, mercado, riesgo y tributación antes de cada nueva posición.

**7) ¿Debo declarar resultados en renta anual?**
En general, SII indica obligación de declarar rentas de inversiones según reglas vigentes y excepciones legales.

**8) ¿Esto reemplaza asesoría tributaria o legal?**
No. Es guía educativa; para casos complejos conviene asesoría profesional.

## Cierre y siguiente lectura

Para conectar esta ejecución con la arquitectura completa de instrumentos y objetivos, vuelve al pilar: [Ahorro e inversión en Chile: instrumentos, costos e impuestos (guía 2026)](/posts/ahorro-e-inversion-en-chile-instrumentos-costos-impuestos-2026/).
