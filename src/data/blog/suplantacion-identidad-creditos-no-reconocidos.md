...
- **Cuentas nuevas asociadas a tu RUT.** Si revisas tu [Informe de Deudas CMF](/posts/informe-deudas-cmf-vs-dicom/) y aparecen productos que no reconoces, actúa de inmediato.
...
El reclamo verbal no deja rastro útil. Ingresa un reclamo escrito con número de folio. La institución tiene plazos regulatorios para responder (generalmente 15 días hábiles para una respuesta de fondo según normativa CMF).
...
_La información de este artículo es de carácter educativo y está basada en la normativa vigente a marzo de 2026. Para más información visita la [CMF](https://www.cmfchile.cl), el [SERNAC](https://www.sernac.cl) o denuncia en la [PDI](https://www.pdichile.cl). Para asesoría gratuita contacta la [Corporación de Asistencia Judicial](https://www.cajmetro.cl/)._
