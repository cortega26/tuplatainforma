...
export const HERO_OUTPUT_DIR = path.join(REPO_ROOT, "output", "hero-images");
...
export const DOWNLOADS_DIR = path.join(HERO_OUTPUT_DIR, "downloads");
export const POOL_DIR = path.join(HERO_SCRIPT_DIR, "pool");
export const POOL_ASSETS_DIR = path.join(POOL_DIR, "assets");
export const POOL_OUTPUT_DIR = path.join(HERO_OUTPUT_DIR, "pool");
export const POOL_MANIFEST_PATH = path.join(POOL_OUTPUT_DIR, "manifest.json");
export const POOL_ASSIGNMENTS_PATH = path.join(POOL_OUTPUT_DIR, "assignments.json");
export const POOL_RUN_STATE_PATH = path.join(POOL_OUTPUT_DIR, "run-state.json");
export const POOL_WORKLIST_PATH = path.join(POOL_OUTPUT_DIR, "worklist.json");
export const POOL_WORKLIST_TEXT_PATH = path.join(POOL_OUTPUT_DIR, "worklist.txt");
